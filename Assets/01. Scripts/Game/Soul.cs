    ...
    public class Soul : MonoBehaviour
    {
        ...
        private IEnumerator FindDirectionCoroutine(int[][] pathGrid, int[][] blockGrid)
        {
            ...
            while (true)
            {
                ...
                if (x > 0 && pathGrid[y][x - 1] == 3 || x > 0 && pathGrid[y][x - 1] == 2)  // аб
                {
                ...
                else if (y < HEIGHT - 1 && pathGrid[y + 1][x] == 3 || y < HEIGHT - 1 && pathGrid[y + 1][x] == 2)  // го
                {
                ...
                else if (x < WIDTH - 1 && pathGrid[y][x + 1] == 3 || x < WIDTH - 1 && pathGrid[y][x + 1] == 2)  // ©Л
                {
                    if (CanMove(x + 1, y, blockGrid))
                    {
                        if (pathGrid[y][x + 1] != 2)
                ...
                else if (y > 0 && pathGrid[y - 1][x] == 3 || y > 0 && pathGrid[y - 1][x] == 2)  // ╩С
                {
                    if (CanMove(x, y - 1, blockGrid))
                    {
                        if (pathGrid[y - 1][x] != 2)
